...
void CGPLMM::setMeanTerm() throw (CGPMixException)
{
	/*
...
{
    //1. check consistency of GP and local data	checkConsistency();
	checkConsistency();
	//2. construct overall GP object for foregrond and background model

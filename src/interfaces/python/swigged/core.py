...
class CKroneckerLMM(ALMM):
    ...
    def getBetaAlt(self):
        """
        getBetaAlt(CKroneckerLMM self)

        Parameters:
            self: limix::CKroneckerLMM *

        """
        return _core.CKroneckerLMM_getBetaAlt(self)
...
class nLLevalKronFunctor(_object):
    ...
    def __init__(self, *args): 
        ...
        __init__(limix::nLLevalKronFunctor self, MatrixXdVec A, MatrixXdVec X, MatrixXd const Y, MatrixXd const S_C1, MatrixXd const S_R1, 
            MatrixXd const S_C2, MatrixXd const S_R2, MatrixXd W) -> nLLevalKronFunctor
